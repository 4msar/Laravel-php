	            ...
	            <div class="container-fluid">
	            	...
	            	<div class="card card-stats">
		            		...
		            		<nav aria-label="Page navigation">
							  <ul class="pagination">
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'1st'?>">1st</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'2nd'?>">2nd</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'3rd'?>">3rd</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'4th'?>">4th</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'5th'?>">5th</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'6th'?>">6th</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'7th'?>">7th</a>
							    </li>
							    <li>
							    <a href="<?php echo base_url().'users/computer/semester/'.'8th'?>">8th</a>
							    </li>
							  </ul>
							</nav>
					</div>
	                        ...
	                        <div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    ...
	                                    <tbody>
	                                   <?php $count = 0; foreach ($computer_list as $u_key){ ?>
										<tr>
